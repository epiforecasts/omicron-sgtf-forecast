---
title: "Estimation of the test to test distribution as a proxy for generation interval distribution for the Omicron variants in England using S-Gene Target Status and Surveillance data"
...
\begin{align}
  ...
  \frac{\bar{G}_\mathrm{SD}^\mathrm{O}}{\bar{G}_\mathrm{SD}^\mathrm{O}} &\sim \text{LogNormal}\left(0, 1 \right) \\
\end{align}
