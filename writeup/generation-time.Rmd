...
Our analysis had several key limitations. Firstly, the surveillance data sources we used to estimate daily growth rates had the potential to bias our analysis both because SGTF may be an imperfect proxy for Omicron and because the public case counts do not include reinfections.
