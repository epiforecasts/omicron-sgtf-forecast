...
\begin{align}
 g^D_{lt} &\sim \text{Normal} \left(r^D_{lt} , \sigma^D_{lt}\right) \\
 R^D_{lt} &= \left(1 + g^D_{lt}  k_D \mu_D  \right)^{\frac{1}{k_D}} \\
 R^O_{lt} &= \alpha R^D_{lt} \\
 g^O_{lt} &= \frac{(R^O_{lt})^2 - 1}{k_O \mu_O} \\
 \sigma^D_{lt} &= \sqrt{\sigma^2 + (\sigma^D_{lt})^2} \\
 r^O_{lt} &\sim \text{Normal}\left(g^O_{lt}, \sigma_c \right) \\
\end{align}
