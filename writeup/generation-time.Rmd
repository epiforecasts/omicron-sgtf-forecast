...
\begin{align}
  ...
  \frac{\bar{G}^\mathrm{O}}{\bar{G}^\mathrm{D}} &\sim  \text{LogNormal}\left(0, 0.1 \right) \\
  \frac{\bar{G}_\mathrm{SD}^\mathrm{O}}{\bar{G}_\mathrm{SD}^\mathrm{D}} &\sim \text{LogNormal}\left(0, 0.1 \right) \\
\end{align}
...
\begin{align}
  ...
  \alpha_\mathrm{SD} &\sim \text{Normal} \left(0, 0.01 \right) \\
\end{align}
...
```{r, fig.height = 9, fig.width = 12, fig.cap = "Posterior samples of the generation time distribution for both Omicron and Delta variants, each generation time prior assumption and data stratification."}
...
```{r, fig.height = 9, fig.width = 9, fig.cap = "Posterior samples of the generation time distribution mean and standard deviation for both Omicron and Delta variants, each generation time prior assumption and data stratification." }
gt_samples %>%
  ggplot() +
