...
```{r, voc-frac, fig.cap = "Estimates of the proportion of reported cases with the Omicron variant for England and by NHS region using both the scaled model and the correlated model on the natural scale. 90% and 60% credible intervals are shown."}
plot(
  sgtf$posterior[,
   variant_relationship := stringr::str_to_sentence(variant_relationship)
