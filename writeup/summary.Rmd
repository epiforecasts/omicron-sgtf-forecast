...
_1. Center for the Mathematical Modelling of Infectious Diseases, London School of Hygiene & Tropical Medicine, London WC1E 7HT, United Kingdom_

### Estimates for `r date_forecast_start`

```{r summary-plot, fig.width = 6, fig.height = 6, fig.cap = "Summary of latest estimates for England and by UKHSA region, showing: bias in S-gene sampling, comparing transmissibility among cases with any SGT result, against cases with no SGT result (1); cumulative % of population reported as a case with Omicron variant; growth rate, and transmission advantage of Omicron variant"}
