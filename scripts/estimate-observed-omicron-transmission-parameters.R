...
fwrite(
  posterior_summary,
  here::here(
    "data", "estimates", "omicron", "retrospective", "posterior_summary.csv"
  )
)
...
fwrite(
  posterior_samples,
  here::here(
    "data", "estimates", "omicron", "retrospective", "posterior_samples.csv"
  )
)
...
fwrite(
  ...
  here::here(
    "data", "estimates", "omicron", "retrospective",
...
fwrite(
  reproduction_no_pp,
  here::here(
    "data", "estimates", "omicron", "retrospective", "reproduction_no_pp.csv"
  )
)
...
fwrite(
  posterior_locations,
  here::here(
    "data", "estimates", "omicron", "retrospective", "posterior_locations.csv"
  )
)
