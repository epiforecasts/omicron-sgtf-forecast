...
forecast_fits_alt <- readRDS(here("sampling", data_alt, "fit", "forecast-fits.rds"))[[variant_relationships]]
forecasts_alt <- readRDS(here("sampling", data_alt, "fit", "forecasts.rds"))[[variant_relationships]]
