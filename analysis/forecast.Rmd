...
We aim to forecast cases arsing from the spread of 2 variants, with the variants in a fixed relationship. This case forecast could then be used an a predictor to forecast hospitalisations.

Some issues include:

- This analysis uses SGTF data for England only. SGTF data are incomplete (e.g. data only include cases tested after a symptomatic rapid test; data exclude SGTF results from contact of cases).

- The forecasting model does not include any account of susceptibility.
...
#### Set up the parameters for the VOC
```{r}
